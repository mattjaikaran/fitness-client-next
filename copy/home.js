...
export const homeCopy = {
  ...
  descriptionTwo: {
    copy: `We recognize the need for different likes, styles, methods, and processes in fitness & wellness engagements. We also recognize there are many radiant, and inspirational fitness & wellness instructors across the Nation. And so we simply would like to provide and introduce the space for these two truths to excel, grow, and connect!  - as a community & on their own terms!`,
